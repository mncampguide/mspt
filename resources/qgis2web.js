...
map.getView().fit([-10366252.553614, 5609332.023875, -10363087.694592, 5610710.805475], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">The MSP Trail</h2>';
        return titleElement;
    })(),
